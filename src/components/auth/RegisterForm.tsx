...
import { Mail, Lock, Eye, EyeOff, TreePine, User } from "lucide-react";
      ...
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Commencez votre arbre généalogique gratuitement
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-300 bg-white py-2.5 px-4 text-sm text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500/20"
                placeholder="Nom"
              />
            </div>
          </div>
